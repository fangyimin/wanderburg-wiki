...
const startLinks = [
  ...
  { href: "/demo", ...home.home.start.cards[1] },
  { href: "/release-date", ...home.home.start.cards[2] },
...
const guideGrid = [
  ...
  { href: "/release-date", title: "Release Date", desc: "EA Sep 8, 2026 and demo window." },
  { href: "/gameplay", title: "Gameplay", desc: "Castle loop, driving, unlocks." },
  { href: "/trailer", title: "Trailer", desc: "Official reveal and channel links." },
  { href: "/system-requirements", title: "System Requirements", desc: "Potato-PC positioning from Steam." },
  { href: "/captains", title: "Captains", desc: "Between-run captains — no fake tiers." },
  { href: "/price", title: "Price / Free?", desc: "Paid EA vs free Steam demo." },
        ...
        <section className="mx-auto max-w-6xl px-4 pb-16 pt-14">
          ...
          <div className="mt-8">
            ...
            <div className="mt-4 flex flex-wrap items-center gap-x-4 gap-y-1 text-sm text-stone-400">
              <Link href="/best-build" className="font-medium text-[hsl(36_78%_62%)] hover:underline">
                {h.hero.secondaryCta}
              </Link>
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="font-medium text-stone-400 hover:text-stone-200 hover:underline"
              >
                {h.hero.tertiaryCta}
              </a>
            </div>
